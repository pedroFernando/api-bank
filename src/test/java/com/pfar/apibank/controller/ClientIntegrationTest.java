...
import com.pfar.apibank.ApiBankApplication;
...
public class ClientIntegrationTest {
    ...
    public void getAllClients() throws Exception {
        ...
        response.andExpect(MockMvcResultMatchers.jsonPath("$[2].dni", is("1103654578")));
    }
    ...
    @Test
    public void testDeleteClientError() throws Exception {
