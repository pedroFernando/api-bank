...
public interface MovementRepository extends JpaRepository<Movement, Long> {
    ...
    @Query(nativeQuery = true, value = "SELECT * FROM MOVEMENT WHERE ACCOUNT_ID = :accountId AND DATE = :date")
    List<Movement> findByAccountIdAndDate(@Param("accountId") Long accountId, @Param("date") LocalDate date);
